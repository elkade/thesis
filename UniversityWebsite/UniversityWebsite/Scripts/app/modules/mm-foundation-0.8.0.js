...
.directive('accordion', function () {
  return {
    ...
    transclude: true,
    replace: false,
    templateUrl: 'scripts/app/modules/template/accordion/accordion.html'
  };
})
...
.directive('accordionGroup', ['$parse', function($parse) {
  return {
    ...
    templateUrl:'scripts/app/modules/template/accordion/accordion-group.html',
...
.directive('alert', function () {
  return {
    ...
    templateUrl: 'scripts/app/modules/template/alert/alert.html',
    transclude:true,
    replace:true,
    scope: {
      type: '=',
 ...
 */
  .directive('modalBackdrop', ['$modalStack', '$timeout', function ($modalStack, $timeout) {
    return {
      restrict: 'EA',
      replace: true,
      templateUrl: 'scripts/app/modules/template/modal/backdrop.html',
      link: function (scope) {
  ...
  .directive('modalWindow', ['$modalStack', '$timeout', function ($modalStack, $timeout) {
    return {
      ...
      replace: true,
      transclude: true,
      templateUrl: 'scripts/app/modules/template/modal/window.html',
...
.directive('pagination', ['$parse', 'paginationConfig', function($parse, config) {
  return {
    ...
    templateUrl: 'scripts/app/modules/template/pagination/pagination.html',
    replace: true,
...
.directive('pager', ['pagerConfig', function(config) {
  return {
    ...
    controller: 'PaginationController',
    templateUrl: 'scripts/app/modules/template/pagination/pager.html',
    replace: true,
    link: function(scope, element, attrs, paginationCtrl) {
...
.directive( 'tooltipPopup', function () {
  return {
    ...
    templateUrl: 'scripts/app/modules/template/tooltip/tooltip-popup.html'
  };
})
...
.directive( 'tooltipHtmlUnsafePopup', function () {
  return {
    ...
    replace: true,
    scope: { content: '@', placement: '@', animation: '&', isOpen: '&' },
    templateUrl: 'scripts/app/modules/template/tooltip/tooltip-html-unsafe-popup.html'
  };
})
...
.directive( 'popoverPopup', function () {
  return {
    ...
    templateUrl: 'scripts/app/modules/template/popover/popover.html'
  };
})
...
.directive('bar', function() {
    return {
        ...
        templateUrl: 'scripts/app/modules/template/progressbar/bar.html',
...
.directive('progressbar', function() {
    return {
        ...
        templateUrl: 'scripts/app/modules/template/progressbar/progressbar.html',
        link: function(scope, element, attrs, progressCtrl) {
...
.directive('rating', function() {
  return {
    ...
    templateUrl: 'scripts/app/modules/template/rating/rating.html',
    replace: true
  };
});
...
.directive('tabset', function() {
  return {
    ...
    templateUrl: 'scripts/app/modules/template/tabs/tabset.html',
    link: function(scope, element, attrs) {
...
.directive('tab', ['$parse', function($parse) {
  return {
    ...
    restrict: 'EA',
    replace: true,
    templateUrl: 'scripts/app/modules/template/tabs/tab.html',
    transclude: true,
    scope: {
      heading: '@',
...
.directive('topBar', ['$timeout','$compile', '$window', '$document', 'mediaQueries',
  function($timeout, $compile, $window, $document, mediaQueries) {
    return {
      ...
      restrict: 'EA',
      replace: true,
      templateUrl: 'scripts/app/modules/template/topbar/top-bar.html',
      transclude: true,
...
.directive('toggleTopBar', ['closest', function (closest) {
  return {
    ...
    restrict: 'A',
    replace: true,
    templateUrl: 'scripts/app/modules/template/topbar/toggle-top-bar.html',
    transclude: true,
...
.directive('topBarSection', ['$compile', 'closest', function($compile, closest) {
  return {
    ...
    restrict: 'EA',
    replace: true,
    templateUrl: 'scripts/app/modules/template/topbar/top-bar-section.html',
    transclude: true,
    link: function(scope, element, attrs, topBar) {
      var section = element;
...
.directive('hasDropdown', ['mediaQueries', function (mediaQueries) {
  return {
    ...
    require: '^topBar',
    restrict: 'A',
    templateUrl: 'scripts/app/modules/template/topbar/has-dropdown.html',
    replace: true,
    transclude: true,
    link: function(scope, element, attrs, topBar) {
...
.directive('topBarDropdown', ['$compile', function($compile) {
  return {
    ...
    restrict: 'A',
    replace: true,
    templateUrl: 'scripts/app/modules/template/topbar/top-bar-dropdown.html',
    transclude: true,
    link: function(scope, element, attrs, ctrls) {
      var topBar = ctrls[0];
...
.directive( 'stepTextPopup', ['$tour', function ( $tour ) {
  return {
    ...
    replace: true,
    scope: { title: '@', content: '@', placement: '@', animation: '&', isOpen: '&' },
    templateUrl: 'scripts/app/modules/template/tour/tour.html',
 ...
 */
  ...
  .directive('typeaheadPopup', function () {
    return {
      ...
      replace:true,
      templateUrl: 'scripts/app/modules/template/typeahead/typeahead-popup.html',
      link:function (scope, element, attrs) {
